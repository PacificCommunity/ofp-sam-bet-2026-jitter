...
if (!file.exists(stock_status_endpoint_file)) {
  stop("The compact recent stock-status endpoint payload is missing.", call. = FALSE)
}
...
mfclshiny::build_jitter_report(
  ...
  management_data = stock_status_endpoints,
